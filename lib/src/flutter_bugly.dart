...
class FlutterBugly {
  ...
  static bool _filterException(bool debugUpload, bool _isDebug, FlutterExceptionHandler handler, String filterRegExp, FlutterErrorDetails details) {
    //默认debug下打印异常，不上传异常
  ...
  static Future<Null> uploadException({@required String message, @required String detail, Map data}) async {
    var map = {};
